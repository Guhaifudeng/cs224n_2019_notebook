...
def question_1f_sanity_check():
    ...
    assert  len(padded_sentences) == len(gold_padded_sentences)
    for padded_sentence,gold_padded_sentence in zip(padded_sentences,gold_padded_sentences):
        assert padded_sentence == gold_padded_sentence ,"Sentence padding is incorrect: it should be:\n {} but is:\n{}".format(gold_padded_sentence, padded_sentence)
